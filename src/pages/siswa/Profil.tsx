          ...
          <form onSubmit={handleUpdateProfil} className="mt-6 space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 w-full rounded-xl border border-slate-300 px-4 py-2 text-sm focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-200"
                required
              />
            </div>
            <div>
          ...
          <form onSubmit={handleGantiPassword} className="mt-6 space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 w-full rounded-xl border border-slate-300 px-4 py-2 text-sm focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-200"
                required
              />
            </div>
            <div>
